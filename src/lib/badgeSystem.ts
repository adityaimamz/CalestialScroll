...
export const BADGE_TIERS: BadgeTier[] = [
  ...
  // TIER 7-9: HIGH (Diamond / Mystic / Ethereal) - Kesan Menyala & Magis
  { 
  ...
  // TIER 10-11: LEGENDARY/GOD (Prismatic / Celestial) - Mengacu pada "UR/LR" di gambar
  { 
  ...
  { 
    ...
    minChapters: 100, 
    style: { 
      // Efek Pelangi/Holografik seperti 'LR'
      background: "linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%)", // Dasar Putih Suci
      color: "#DAA520", // Emas
      border: "transparent", // Trick untuk gradient border
      glow: "rainbow", // Special flag
      textShadow: "none"
    } 
  },
];
